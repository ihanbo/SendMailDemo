...
public class MailManager {
    ...
    private static final String MAIL_FROM = "330880496@qq.com";
    private static final String MAIL_FROM_PWD = "HB-919119";
    /**
     * 接收者账户
     */
    private static final String MAIL_TO1 = "ihanbo@sina.cn";

    /**
     * QQ邮箱服务器
     */
    private static final String VALUE_MAIL_HOST_QQ = "smtp.qq.com";
    ...
    protected Boolean doInBackground(MimeMessage mimeMessage) {
        try {
            //发送附件时会报异常：
     ...
     * @param filePath
     */
    public void sendMailWithFile(final String title, final String content, final String filePath) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                MimeMessage mimeMessage = createMessage(title, content);
    ...
    public void sendMailWithFile(final String title, final String content, final List<String> pathList) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                MimeMessage mimeMessage = createMessage(title, content);
